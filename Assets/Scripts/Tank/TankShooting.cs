...
public class TankShooting : MonoBehaviour
{
	...
	private void FireBIG()
	{
		...
		if (num2 <= 3f) {
			...
			shellInstance1.velocity =m_MaxLaunchForce * m_FireTransform.forward;
			num2++;
		}
		if (num2 > 3f) {
			Rigidbody shellInstance2 = Instantiate (m_Shell2, m_FireTransform.position, m_FireTransform.rotation) as Rigidbody;
			shellInstance2.velocity = m_MaxLaunchForce * m_FireTransform.forward;
		}
